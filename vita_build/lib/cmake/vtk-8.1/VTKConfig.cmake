...
set(_vtk_installed_prefix "/app/vita_build/lib/cmake/vtk-8.1")
...
if (_vtk_installed_prefix_full STREQUAL _vtk_requested_prefix_full)
  set(VTK_INSTALL_PREFIX "/app/vita_build")
else ()
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "/app/vita_build/bin")
  else ()
    set (VTK_RUNTIME_DIRS "/app/vita_build/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "/app/vita_build/vtk-prefix/src/vtk-build/bin")
  else ()
    set (VTK_RUNTIME_DIRS "/app/vita_build/vtk-prefix/src/vtk-build/lib")
  endif ()
endif()
